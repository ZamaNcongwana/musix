	...
	function initAlbumPlayer()
	{
		if($('#jplayer_1').length)
		{
			...
			[
				...
				{
					title:"Thethelela",
					artist:"Zama  x Da Enrew x Mshengu",
					mp3:"files/Thethelela.mp3",
					duration:"4.52"
				},
				{
					title:"Ngixolele",
					artist:"Zama ",
					mp3:"files/Ngixolele.mp3",
					duration:"4.20"
				},
				{
					title:"Mama",
				...
				{
					title:"Don't give up",
					artist:"Mshengu x Ayanda",
					mp3:"files/Don't give up.mp3",
					duration:"1.27"
				}
